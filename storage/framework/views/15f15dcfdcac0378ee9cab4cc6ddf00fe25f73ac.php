            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <?php echo e(Html::image($result->image,'', ['class'=>'','height'=>'100','width'=>'200'])); ?>
                ...
                <li <?php if($url=='learning-partner/new-vendor') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('hr.new.vendor')); ?>"><i class="fa fa-users"></i> <span class="nav-label">Vendor Management</span></a>
                </li>
                
                <li <?php if($url=='learning-partner/product-list') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('hr.list.product')); ?>"><i class="fa fa-users"></i> <span class="nav-label">Learning Management</span></a>
                </li>
               
                <li <?php if($url=='learning-partner/employee-list') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('hr.list.employee')); ?>"><i class="fa fa-users"></i> <span class="nav-label">User Management</span></a>
                </li>
...
<?php /**PATH /home2/tossamba/public_html/youngman/software/resources/views/hr/layouts/app.blade.php ENDPATH**/ ?>