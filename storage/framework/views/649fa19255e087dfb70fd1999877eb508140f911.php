        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li <?php if($url=='admin/new-company' || $url=='admin/company-list' || $url=='admin/edit-company') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('admin.new.company')); ?>"><i class="fa fa-dribbble"></i> <span class="nav-label">Company Management</span> </a>
                   
                </li>
                
                 <li <?php if($url=='admin/new-category' ||  $url=='admin/edit-category') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('admin.new.category')); ?>"><i class="fa fa-dribbble"></i> <span class="nav-label">Project Category</span> </a>
                   
                </li>
                
                <li <?php if($url=='admin/new-project' || $url=='admin/project-list' || $url=='admin/edit-project') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('admin.new.project')); ?>"><i class="fa fa-dribbble"></i> <span class="nav-label">Project Management</span> </a>
                   
                </li>
                
                <li <?php if($url=='admin/new-employee' || $url=='admin/employee-list' || $url=='admin/edit-employee') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('admin.new.employee')); ?>"><i class="fa fa-dribbble"></i> <span class="nav-label">Employee Management</span> </a>
                </li>
                
                <li <?php if($url=='admin/new-assign-project' || $url=='admin/edit-assign-project') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('admin.new.assignproject')); ?>"><i class="fa fa-dribbble"></i> <span class="nav-label">Assign Project</span> </a>
                </li>
              
              
                <li <?php if($url=='admin/daily-status' || $url=='admin/edit-assign-project') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('admin.new.status')); ?>"><i class="fa fa-dribbble"></i> <span class="nav-label">Employee Daily Status</span> </a>
                </li>
...
</script><?php /**PATH /home2/ssashealthcare/public_html/Tos/resources/views/admin/layouts/app.blade.php ENDPATH**/ ?>