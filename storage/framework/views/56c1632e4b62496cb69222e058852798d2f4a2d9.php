        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
               ...
               <?php if(auth::user()->is_admin == 1): ?>
                ...
                <li <?php if($url=='admin/new-dc') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('admin.new.dc')); ?>"><i class="fa fa-dribbble"></i> <span class="nav-label">Diagnostic Center</span> </a>
...
</script><?php /**PATH /home2/ssashealthcare/public_html/Software/resources/views/admin/layouts/app.blade.php ENDPATH**/ ?>