    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <?php echo e(Html::image($result->image,'', ['class'=>'img_logo'])); ?>
                ...
                <li <?php if($url=='healthcare') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('healthcare.home')); ?>"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboard</span></a>
                </li>
                
                 <li <?php if($url=='healthcare/new-package') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('admin.new.package')); ?>"><i class="fa fa-th-large"></i> <span class="nav-label">Packages</span></a>
                </li>
                <?php if(auth::user()->is_admin == 1): ?>
                  <li <?php if($url=='healthcare/new-assign-package' || $url=='healthcare/edit-assign-package') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('admin.new.assign')); ?>"><i class="fa fa-th-large"></i> <span class="nav-label">Assign Package</span></a>
                </li>
                <?php endif; ?>
                
                <li <?php if($url=='admin/mis' || $url=='admin/package-bookings-mdra'|| $url=='admin/package-bookings-mdra-done' || $url=='admin/package-bookings-pending' || $url=='admin/package-bookings' || $url=='admin/package-bookings-schedule-a-call' || $url=='admin/package-bookings-cancel') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('admin.my.booking.schedule')); ?>"><i class="fa fa-dribbble"></i> <span class="nav-label">Package Status </span> <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <!--<li><a href="<?php echo e(route('admin.my.booking.schedule')); ?>">To be contacted</a></li>-->
                        <!--<li><a href="<?php echo e(route('admin.my.booking.pending')); ?>">Show/ No Show</a></li>-->
                        <!--<li><a href="<?php echo e(route('admin.my.booking.mdra')); ?>">Medical Done Report Awaited  </a></li>-->
                        <!--<li><a href="<?php echo e(route('admin.my.booking')); ?>">Medical Partial Process Done  </a></li>-->
                        
                        <!--<li><a href="<?php echo e(route('admin.my.booking.cancel')); ?>">Appointment Cancel </a></li>-->
                        <!--<li><a href="<?php echo e(route('admin.my.booking.mdradone')); ?>">Closed Cases </a></li>-->
                        <!-- <li><a href="<?php echo e(route('admin.mis')); ?>">MIS Report </a></li>-->
                        
                         <li><a href="javascript::void(0);">To be contacted</a></li>
                        <li><a href="javascript::void(0);">Show/ No Show</a></li>
                        <li><a href="javascript::void(0);">Medical Done Report Awaited  </a></li>
                        <li><a href="javascript::void(0);">Medical Partial Process Done  </a></li>
                        
                        <li><a href="javascript::void(0);">Appointment Cancel </a></li>
                        <li><a href="javascript::void(0);">Closed Cases </a></li>
                         <li><a href="javascript::void(0);">MIS Report </a></li>
                    </ul>
                </li>
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li>
                <a class="" href="<?php echo e(route('admin.home')); ?>">
                                       <i class="fa fa-sign-out"></i> <?php echo e(__('Back To Main Admin')); ?>
        ...
        <?php echo $__env->make('healthcare.layouts.adminError', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo e(Html::script('public/assest/js/plugins/chartJs/Chart.min.js')); ?>
...
<div class="modal inmodal" id="myRechedulelModel" tabindex="-1" role="dialog" aria-hidden="true">
                                ...
                                <div class="modal-content animated bounceInRight">
                                        ...
                                        <?php echo e(Form::open(['route'=>['admin.booking.rechedule'],'class'=>'classname','id'=>'myForm','files'=>'true','onsubmit'=>'return checkForm()'])); ?>
                                   ...
                                   <?php echo e(Form::select('dc_id', [],'', ['class'=>'form-control','placeholder'=>'Select Diagnostic Center'])); ?>
                                    ...
                                    <span class="" style="color:red"> <?php echo e($errors->first('dc_id')); ?> <span>
                                        ...
                                        <label>ReSchedule Date</label>
                                         ...
                                         <input type="date" required  class="form-control rechedule_date" name="rechedule_date"
                                          id="datepickerrr" data-zdp_readonly_element="true"></div>
...
</script><?php /**PATH /home2/ssashealthcare/public_html/Software/resources/views/healthcare/layouts/app.blade.php ENDPATH**/ ?>