    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li <?php if($url=='company/event-list') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('hr.list.event')); ?>"><i class="fa fa-users"></i> <span class="nav-label">Event Management</span></a>
                </li>
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-muted welcome-message">Welcome to <?php echo e($result->company ?? 'Company Name'); ?></span>
                </li>
...
<div class="modal inmodal" id="userModelDetails" tabindex="-1" role="dialog" aria-hidden="true">
                            ...
                            </div><?php /**PATH /home/t5scjne8ghxo/public_html/healthcare/resources/views/hr/layouts/app.blade.php ENDPATH**/ ?>