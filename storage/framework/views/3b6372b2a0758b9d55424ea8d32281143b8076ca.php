                    ...
                    <div class="ibox ">
                        ...
                        <?php echo csrf_field(); ?>
                                ...
                                <label class="col-sm-2 col-form-label">Package Price</label>
                                    ...
                                    <div class="col-sm-4"><input type="text" value="<?php echo e(old('price')); ?>" name="price" class="form-control">
                                ...
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Select Test</label>
                                    ...
                                    <div class="i-checks"><label> <input type="checkbox" checked name="tests[]" value="<?php echo e($val->id); ?>"> <i></i> <?php echo e($val->name); ?> </label></div>
...
<div class="col-sm-10">
<?php echo e(Form::select('status', ['1'=>'Active','0'=>'De Active'],'', ['class'=>'form-control'])); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/seoagencyindia/public_html/healthcare/resources/views/admin/package/add.blade.php ENDPATH**/ ?>