...
<body>
    ...
    <section class="w3l-hotair-form">
        <h1>Welcome to <span>SSAS Healthcare</span></h1>
            ...
            <div class="workinghny-form-grid">
                <div class="main-hotair">
                    <div class="content-wthree">
                        <div class="logo" style="text-align:center;"><img src="https://ssashealthcare.com/wp-content/uploads/2022/01/SSAS-Logo1.png" height="150px" width="120px"></img></div>
                        <h2>Admin Log In</h2>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="copyright text-center">
            <p class="copy-footer-29">© <strong>Copyright</strong> SSAS Company</p>
        </div>
        <!-- //copyright-->
    </section>
    <!-- //form section start -->
...
</html><?php /**PATH /home2/ssashealthcare/public_html/Software/resources/views/auth/login.blade.php ENDPATH**/ ?>