...
<div class="modal inmodal" id="myModalBooking" tabindex="-1" role="dialog" aria-hidden="true">
                                ...
                                <div class="modal-content animated bounceInRight">
                                        ...
                                        <div class="modal-body ">
                                            ...
                                            <div class="form-group" style="color:green"><label>Choose Booking Date</label> 
                                            <input  type="text" style="height: 37px;    width: 437px;" class="" name="booking_date" id="datepickerr" data-zdp_readonly_element="true">
</div>

                                            <div class="form-group" style="color:green"><label>Choose Type</label> 
                                            <?php echo e(Form::select('type', ['self'=>'Self','my dependent'=>'my Dependent'],'', ['class'=>'form-control mydepended_self'])); ?>
...
<?php echo $__env->make('employee.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\healthcare\resources\views/employee/package/list.blade.php ENDPATH**/ ?>