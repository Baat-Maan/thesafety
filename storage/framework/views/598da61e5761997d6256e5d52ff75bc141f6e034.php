            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <?php echo e(Html::image($result->image,'', ['class'=>'','height'=>'40','width'=>'150'])); ?>
                ...
                <li <?php if($url=='admin/new-call-centre' || $url=='admin/call-centre-list' || $url=='admin/edit-call-centre') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('admin.new.call.centre')); ?>"><i class="fa fa-dribbble"></i> <span class="nav-label">Call Center Management</span> </a>
                    
                </li>
                
                
                <!--<li <?php if($url=='admin/feedback') { ?> class="active" <?php } ?>>-->
                <!--    <a href="<?php echo e(route('admin.list.feedback')); ?>"><i class="fa fa-users"></i> <span class="nav-label">Company Feedback</span></a>-->
                <!--</li>-->
                <!--<li <?php if($url=='admin/new-call-centre' || $url=='admin/call-centre-list' || $url=='admin/edit-call-centre') { ?> class="active" <?php } ?>>-->
                ...
                <!-- <?php $url =  "https://avyuktcorp.com/CCmanagment/callcenter/register/" ?>-->
                <!-- <li>-->
                <!--    <a href="<?php echo e($url); ?>"><i class="fa fa-th-large"></i> <span class="nav-label">CC Management</span></a>-->
                <!--</li>-->
                ...
                <li <?php if($url=='admin/state-list' ) { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('admin.list.state')); ?>"><i class="fa fa-eraser"></i> <span class="nav-label">State Management</span> </a>
                   
                </li>
                <li <?php if($url=='admin/city-list') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('admin.list.city')); ?>"><i class="fa fa-eraser"></i> <span class="nav-label">City Management</span> </a>
...
</script><?php /**PATH /home2/ssashealthcare/public_html/Healthcare/resources/views/admin/layouts/app.blade.php ENDPATH**/ ?>