        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li <?php if($url=='admin/mis' || $url=='admin/package-bookings-mdra' || $url=='admin/package-bookings-pending' || $url=='admin/package-bookings' || $url=='admin/package-bookings-schedule-a-call' || $url=='admin/package-bookings-cancel') { ?> class="active" <?php } ?>>
                    ...
                    <ul class="nav nav-second-level">
                        <li><a href="<?php echo e(route('admin.my.booking.schedule')); ?>">Appointment Schedule</a></li>
                        <li><a href="<?php echo e(route('admin.my.booking.pending')); ?>">Appointment in Process</a></li>
...
</script><?php /**PATH C:\xampp\htdocs\final-health\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>