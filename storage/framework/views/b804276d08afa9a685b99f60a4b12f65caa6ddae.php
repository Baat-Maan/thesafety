                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                             <?php if($val->projectStatus == 'Finished'): ?>
                                                <span class="label label-success" >Finished </span>
                                               <?php elseif($val->projectStatus == 'Cancelled'): ?>
                                               <span class="label label-danger" >Cancelled</span>
                                                <?php elseif($val->projectStatus == 'On Hold'): ?>
                                               <span class="label label-warning" >On Hold</span>
                                                <?php elseif($val->projectStatus == 'In Process'): ?>
...
<div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Project Dialy Status List</h5>
...
<?php echo $__env->make('employee.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/tossamba/public_html/resources/views/employee/home.blade.php ENDPATH**/ ?>