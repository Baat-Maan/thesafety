            ...
            <div class="col-lg-7">
                ...
                <div class="col-lg-5">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                        <form method="POST" action="<?php echo e(route('employee.update.password')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('employee.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/tossamba/public_html/resources/views/employee/updateProfile.blade.php ENDPATH**/ ?>