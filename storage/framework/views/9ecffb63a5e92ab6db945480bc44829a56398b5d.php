                        ...
                        <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group  row">
                                    ...
                                    <label class="col-sm-2 col-form-label">Select Status* </label>
                                        ...
                                        <div class="col-sm-10"> 
                                            <?php echo e(Form::select('status', ['Still Pending'=>'Still Pending','Completed'=>'Completed','On Hold'=>'On Hold'],'', ['class'=>'form-control status','placeholder'=>'Select Status','onchange'=>'selectStatus()'])); ?>
                                ...
                                <label class="col-sm-2 col-form-label"> Due To</label>
                                    ...
                                    <span class="" style="color:red"> <?php echo e($errors->first('reason')); ?> <span>
                                </div>
                                </div>
...
<?php echo $__env->make('employee.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/tossamba/public_html/resources/views/employee/daily_status/add.blade.php ENDPATH**/ ?>