        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="col-lg-12">
                    ...
                    <div class="ibox ">
                        ...
                        <?php echo e(Form::open(['route'=>['admin.update.dc',$result->id],'class'=>'classname','id'=>'myForm','files'=>'true'])); ?>
                        ...
                        <div class="form-group  row">
                                ...
                                <div class="form-group  row">
                                    ...
                                    <label class="col-sm-2 col-form-label">State</label>
                                        ...
                                        <div class="col-sm-10"> 
                                            <?php echo e(Form::select('state_id', $states,$result->state_id, ['class'=>'form-control state_id','placeholder'=>'Select State','onchange'=>'getCities()'])); ?>
                                ...
                                <span class="" style="color:red"> <?php echo e($errors->first('state_id')); ?> <span>
                                 ...
                                 <div class="col-sm-10 cityDropdown"> 
                                     <?php echo e(Form::select('city_id', $city,$result->city_id, ['class'=>'form-control','placeholder'=>'Select City'])); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/t5scjne8ghxo/public_html/healthcare/resources/views/admin/dc/edit.blade.php ENDPATH**/ ?>