            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox ">
                        ...
                        <form method="get" action="<?php echo e(route('admin.list.call.centre')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        <td colspan="5" style="color:red; text-align:center">Record Not Found.....</td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/seoagencyindia/public_html/healthcare/resources/views/admin/cell_center/list.blade.php ENDPATH**/ ?>