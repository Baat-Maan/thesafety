...
<div class="wrapper wrapper-content">
  <div class="row">
     ...
     <div class="col-lg-3">
        ...
        <div class="col-lg-3">
        <a href="<?php echo e(route('admin.list.project')); ?>" style="color:inherit;">
        ...
        <div class="row">
        <div class="col-lg-3">
        <a href="<?php echo e(route('admin.list.project','status=In Proces')); ?>" style="color:inherit;">
        ...
        <div class="col-lg-3">
        <a href="<?php echo e(route('admin.list.project','status=Finished')); ?>" style="color:inherit;">
        ...
        <div class="col-lg-3">
        <a href="<?php echo e(route('admin.list.project','status=Cancelled')); ?>" style="color:inherit;">
        ...
        <div class="col-lg-3">
        <a href="<?php echo e(route('admin.list.project','status=On Hold')); ?>" style="color:inherit;">
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox tablecs">
                        <div class="ibox-title">
                            <h5>Employee Daily Working Status</h5>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/tossamba/public_html/resources/views/admin/home.blade.php ENDPATH**/ ?>