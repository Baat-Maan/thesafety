            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li <?php if($url=='admin/new-company' || $url=='admin/company-list' || $url=='admin/edit-company') { ?> class="active" <?php } ?>>
                  ...
                  <li <?php if($url=='admin/new-category' ||  $url=='admin/edit-category') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('admin.new.category')); ?>"><i class="fa-solid fa-list-check"></i> <span class="nav-label">Product Category</span> </a>
                   
                </li>
                
                <li <?php if($url=='admin/new-product' || $url=='admin/product-list' || $url=='admin/edit-product') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('admin.new.product')); ?>"><i class="fa fa-business-time"></i> <span class="nav-label">Product Management</span> </a>
                   
                </li>
                
                  <li <?php if($url=='admin/new-employee' || $url=='admin/employee-list' || $url=='admin/edit-employee') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('admin.new.employee')); ?>"><i class="fa fa-user"></i> <span class="nav-label">Vendor Management</span> </a>
                </li>
                
                   <li <?php if($url=='admin/new-assign-product' || $url=='admin/assign-product-list' || $url=='admin/edit-assign-product') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('admin.new.assignproduct')); ?>"><i class="fa fa-user"></i> <span class="nav-label">Assign Product</span> </a>
                </li>
...
</script><?php /**PATH /home2/tossamba/public_html/productManagement/software/resources/views/admin/layouts/app.blade.php ENDPATH**/ ?>