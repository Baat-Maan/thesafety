        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="col-lg-12">
                    ...
                    <div class="ibox ">
                        ...
                        <form method="POST" action="<?php echo e(route('employee.save.dependent')); ?>" enctype="multipart/form-data" onSubmit="return submitButtion()">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('employee.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/avyukhl1/public_html/AHC/resources/views/employee/dependent/add.blade.php ENDPATH**/ ?>