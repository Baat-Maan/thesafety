				...
				<div class="form-right">
					<div class="overlay">
						<div class="grid-info-form">
							...
							<a href="<?php echo e(env('APP_URL')); ?>employeement-user/login" class="read-more-1 btn">Login Account</a>
						</div>
				...
				<div class="form-left">
                    ...
                    <?php if(Session::has('success')): ?>
                            <div class="alert alert-success" style="color:green">
                                ...
                                <?php endif; ?>
						<h4>Join Us</h4>
						<h4><b><?php echo e($result->company); ?></b> <span>Pre Employee Registration</span></h4> 
					</div>
                    <?php echo e(Form::open(['route'=>['preemployee.register',$result->id,$result->slug],'class'=>'signin-form','id'=>'myForm','files'=>'true'])); ?>
...
</html><?php /**PATH /home4/avyukhl1/public_html/AHC/resources/views/employment_register.blade.php ENDPATH**/ ?>