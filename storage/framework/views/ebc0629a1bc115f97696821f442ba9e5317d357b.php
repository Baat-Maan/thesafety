        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li <?php if($url=='company/employee-list') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('hr.list.employee')); ?>"><i class="fa fa-users"></i> <span class="nav-label">AHC Employee Management</span></a>
                </li>
                <li <?php if($url=='company/preemployee-list') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('hr.list.preemployee')); ?>"><i class="fa fa-users"></i> <span class="nav-label">Pre-Employee Management</span></a>
                </li>
                 <li <?php if($url=='company/package-list' || $url=='company/pre-package-list') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('hr.list.package')); ?>"><i class="fa fa-eraser"></i> <span class="nav-label">Package List</span> <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li><a href="<?php echo e(route('hr.list.package')); ?>">AHC Package List</a></li>
                        <li><a href="<?php echo e(route('hr.preemp.package')); ?>">Pre-Employee Package List</a></li>
                       
                    </ul>
                </li>
                 <li <?php if($url=='company/package-bookings' || $url=='company/pre-package-bookings') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('hr.my.booking')); ?>"><i class="fa fa-eraser"></i> <span class="nav-label">Package Booking Status</span> <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li><a href="<?php echo e(route('hr.my.booking')); ?>">AHC Package Booking List</a></li>
                        <li><a href="<?php echo e(route('hr.preemp.booking')); ?>">Pre-Employee Package Booking List</a></li>
                ...
                <li <?php if($url=='company/new-faq' || $url=='company/faq-list' || $url=='company/edit-faq') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('hr.list.faq')); ?>"><i class="fa fa-eraser"></i> <span class="nav-label">FAQ Management</span> <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li><a href="<?php echo e(route('hr.new.faq')); ?>">Add New</a></li>
                        <li><a href="<?php echo e(route('hr.list.faq')); ?>">View List</a></li>
                       
                    </ul>
                </li>
  <li <?php if($url=='company/package-bookings') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('hr.list.feedback')); ?>"><i class="fa fa-book"></i> <span class="nav-label"> Feedback List</span></a>
                </li>
                
                <li <?php if($url=='company/help') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('hr.help')); ?>"><i class="fa fa-user-o"></i> <span class="nav-label">Help Center</span></a>
                </li>
...
<div class="modal inmodal" id="userModelDetails" tabindex="-1" role="dialog" aria-hidden="true">
                                ...
                                <div class="modal inmodal" id="myPreUrllModel" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                <div class="modal-content animated bounceInRight">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                            <i class="fa fa-laptop modal-icon"></i>
                                            <h4 class="modal-title">Pre Employee Registration URL</h4>
                                        </div>
                                        
                                        <div class="modal-body">
                                          
                                        <div class="form-group" style="color:">
                                        <h5><span style="color:red">Pre Employee Registration URL  </span>: <a target="_blank" href="<?php echo e(env('APP_URL')); ?>employment-registration/<?php echo e(Auth::user()->id); ?>/<?php echo e(Auth::user()->slug); ?>" ><?php echo e(env('APP_URL')); ?>employment-registration/<?php echo e(Auth::user()->id); ?>/<?php echo e(Auth::user()->slug); ?></a> </h5>
                                        </div>
                                        <div class="modal-footer">
                                ...
                                <?php /**PATH /home4/avyukhl1/public_html/AHC/resources/views/hr/layouts/app.blade.php ENDPATH**/ ?>