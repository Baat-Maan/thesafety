  ...
  <?php echo Form::open(['role' => 'form','route' => "admin.save.project",'class' => 'mws-form','method' => 'post', 'files' => true]); ?>
     ...
     <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group  row">
                                    ...
                                    <div class="col-sm-4"><input type="date" value="<?php echo e(old('start_date')); ?>" name="start_date" class="form-control">
                                    ...
                                    <div class="col-sm-4"><input type="date" value="<?php echo e(old('end_date')); ?>" name="end_date" class="form-control">
      ...
      <div class="hr-line-dashed"></div>
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Project Cost*</label>
                                    ...
                                    <div class="col-sm-4">
                                       <?php echo Form::text('cost', '',['class' => 'form-control']); ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="table_id">
                                    ...
                                    <tr>
                                        ...
                                        <td ><?php echo e($val->gst); ?>

                                           </td>
                                            <td ><?php echo e($val->total_cost); ?>
                                        ...
                                        <td>
                                         ...
                                         <?php if($val->status == 'In Process'): ?>
							
							
							<button  onclick="status('<?php echo e($val->id); ?>')"; data-toggle="modal" data-target="#myModalStatus" class="btn btn-success" type="button"><i class="fa fa-ban"></i></button>
...
<div class="modal inmodal" id="myModalStatus" tabindex="-1" role="dialog" aria-hidden="true">
                                ...
                                <div class="modal-content animated bounceInRight">
                                    ...
                                    <div class="col-sm-10">
                                         <?php echo e(Form::select('status', ['Finished'=>'Finished','Cancelled'=>'Cancelled'],'', ['class'=>'form-control status','onchange'=>'changeProjectStatus()','placeholder'=>'Select Status'])); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/ssashealthcare/public_html/Tos/resources/views/admin/project/add.blade.php ENDPATH**/ ?>