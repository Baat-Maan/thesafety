...
<div class="row wrapper border-bottom white-bg page-heading">
  ...
  <?php echo Form::open(['role' => 'form','route' => "admin.save.company",'class' => 'mws-form','method' => 'post', 'files' => true]); ?>
                                ...
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Head of Company</label>
                                    ...
                                    <div class="col-sm-4">
                                         <?php echo Form::text('perifix', '',['class' => 'form-control']); ?>
     ...
     <div class="hr-line-dashed"></div>
      ...
      <div class="hr-line-dashed"></div>
                                ...
                                value="<?php echo e($segment); ?>" id="inlineCheckbox<?php echo e($segment); ?>"> <?php echo e($segment); ?> <br/>
                                     ...
                                     <br/>
                                  <span class="" style="color:red"> <?php echo e($errors->first('products')); ?> <span>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="table_id">
                                    ...
                                    <tr>
                                        ...
                                        <th width="5%">Employee Related Srvices</th>
                                        <th width="5%">Company Related Srvices</th>
                                    ...
                                    <tr>
                                        ...
                                        <td ><?php echo e($val->products); ?>

                                           </td>
                                            <td ><?php echo e($val->company_products); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/ssashealthcare/public_html/Software/resources/views/admin/company/add.blade.php ENDPATH**/ ?>