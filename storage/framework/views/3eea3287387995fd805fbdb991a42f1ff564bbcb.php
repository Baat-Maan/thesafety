                    ...
                    <div class="ibox ">
                        ...
                        <?php echo csrf_field(); ?>
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Company Name</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" value="<?php echo e(old('company')); ?>" name="company" class="form-control" style="text-transform:capitalize">
                                ...
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Head of Company</label>
                                    ...
                                    <div class="col-sm-4"><input type="text" value="<?php echo e(old('name')); ?>" name="name" class="form-control" style="text-transform:capitalize">
                                    ...
                                    <div class="col-sm-4"><input type="text" value="<?php echo e(old('perifix')); ?>" name="perifix" class="form-control">
                                ...
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Email</label>
                                    ...
                                    <div class="col-sm-4"><input type="text" value="<?php echo e(old('email')); ?>" name="email" class="form-control">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/ssashealthcare/public_html/Healthcare/resources/views/admin/company/add.blade.php ENDPATH**/ ?>