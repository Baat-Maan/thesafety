        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="col-lg-7">
                    ...
                    <div class="ibox ">
                        ...
                        <form method="POST" action="<?php echo e(route('call_center.update.profile')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                ...
                <div class="col-lg-5">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                        <form method="POST" action="<?php echo e(route('call_center.update.password')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('call_center.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/seoagencyindia/public_html/healthcare/resources/views/call_center/updateProfile.blade.php ENDPATH**/ ?>