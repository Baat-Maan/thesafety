            ...
            <div class="workinghny-form-grid">
                <div class="main-hotair">
                    <div class="content-wthree">
                        ...
                        <?php endif; ?>
                        <form method="POST" action="<?php echo e(route('call.center.login')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="copyright text-center">
            <p class="copy-footer-29">© 2022 OHC. All rights reserved | Design by <a
                        href="#">Avyukt</a></p>
        </div>
        <!-- //copyright-->
    </section>
...
</html><?php /**PATH /home4/seoagencyindia/public_html/healthcare/resources/views/call_center/login.blade.php ENDPATH**/ ?>