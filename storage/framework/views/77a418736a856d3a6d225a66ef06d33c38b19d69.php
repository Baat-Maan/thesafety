    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li <?php if($url=='call-center/mis' || $url=='call-center/package-bookings-mdra' || $url=='call-center/package-bookings-pending' || $url=='call-center/package-bookings' || $url=='call-center/package-bookings-schedule-a-call' || $url=='call-center/package-bookings-cancel') { ?> class="active" <?php } ?>>
                    ...
                    <ul class="nav nav-second-level">
                        <li><a href="<?php echo e(route('call_center.my.booking.schedule')); ?>">Schedule Call</a></li>
                        <li><a href="<?php echo e(route('call_center.my.booking.pending')); ?>">Show / Noshow </a></li>
                        
                        
                        
                        <li><a href="<?php echo e(route('call_center.my.booking')); ?>">Partial Process Done  </a></li>
                        <li><a href="<?php echo e(route('call_center.my.booking.mdra')); ?>">MDRA  </a></li>
                        <li><a href="<?php echo e(route('call_center.my.booking.cancel')); ?>">Cancel </a></li>
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-muted welcome-message">Welcome to <?php echo e($result->name); ?></span>
                </li>
...
<div class="modal inmodal" id="myRechedulelModel" tabindex="-1" role="dialog" aria-hidden="true">
                                ...
                                <div class="modal-content animated bounceInRight">
                                        ...
                                        <?php
                                    $statesBlade = DB::table('states')->where('is_deleted', 0)->pluck('name','id');


                                    ?>
                                         <div class="form-group" style="color:green"><label>Choose State</label> 
                                        <?php echo e(Form::select('state_id', $statesBlade,'', ['class'=>'form-control state_id','placeholder'=>'Select State','onchange'=>'getCities()'])); ?>
...
</script><?php /**PATH /home4/seoagencyindia/public_html/healthcare/resources/views/call_center/layouts/app.blade.php ENDPATH**/ ?>