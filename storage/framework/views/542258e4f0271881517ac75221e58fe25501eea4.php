                        ...
                        <div class="form-group  row"><label class="col-sm-2 col-form-label">Company Name</label>
                               ...
                               <div class="hr-line-dashed"></div>
                                <div class="form-group  row"><label class="col-sm-2 col-form-label"> Contact Person Email</label>
                                    ...
                                    <div class="col-sm-4">
                                       <?php echo Form::text('contact_person_email', $result->contact_person_email,['class' => 'form-control', 'style'=>"text-transform:capitalize"]); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/tossamba/public_html/youngman/software/resources/views/admin/company/edit.blade.php ENDPATH**/ ?>