                    ...
                    <div class="ibox ">
                        ...
                        <div class="form-group  row">
                                    ...
                                    <label class="col-sm-2 col-form-label">Package</label>
                                        ...
                                        <div class="col-sm-10"> 
                                            <?php echo e(Form::select('package_id', $package,$result->package_id, ['class'=>'form-control','placeholder'=>'Select Package'])); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\healthcare\resources\views/admin/test/edit.blade.php ENDPATH**/ ?>