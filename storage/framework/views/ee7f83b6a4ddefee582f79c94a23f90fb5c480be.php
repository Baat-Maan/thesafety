        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li <?php if($url=='user/daily-status') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('user.new.status')); ?>"><i class="fa fa-th-large"></i> <span class="nav-label">Daily Status</span></a>
                </li>
...
<?php /**PATH /home2/ssashealthcare/public_html/Tos/resources/views/employee/layouts/app.blade.php ENDPATH**/ ?>