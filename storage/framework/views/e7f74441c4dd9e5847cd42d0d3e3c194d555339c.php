...
<div class="modal inmodal" id="myModalViewPackage" tabindex="-1" role="dialog" aria-hidden="true">
                            ...
                            function submitButtion (){
                                ...
                                $('.booking_mode').click(function(){
                                    ...
                                    if(booking_mode=='DC-Visit'){
                                            $('.dc_select').show();
                                            $('.address_home_collection').hide();
                                            
                                            
                                    } else {
                                        $('.dc_select').hide();
                                        $('.address_home_collection').show();
                                    }
                                })
...
<?php /**PATH C:\xampp\htdocs\final-health\resources\views/employee/layouts/app.blade.php ENDPATH**/ ?>