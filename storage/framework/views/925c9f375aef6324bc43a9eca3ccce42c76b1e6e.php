        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="col-lg-7">
                    ...
                    <div class="ibox ">
                        ...
                        <form method="POST" action="<?php echo e(route('employee.update.profile')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Company Name</label>

                                    <div class="col-sm-10"><input type="text" readonly value="<?php echo e($companyName ?? old('company')); ?>" name="company" class="form-control">
                                ...
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Mobile No.</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" value="<?php echo e($result->mobile ?? old('mobile')); ?>" name="mobile" class="form-control">
                                    <span class="" style="color:red"> <?php echo e($errors->first('mobile')); ?> <span></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                ...
                <div class="col-lg-5">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                        <form method="POST" action="<?php echo e(route('hr.update.password')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('employee.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/seoagencyindia/public_html/healthcare/resources/views/employee/updateProfile.blade.php ENDPATH**/ ?>