        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li <?php if($url=='user/package-list') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('employee.list.package')); ?>"><i class="fa fa-list-ol"></i> <span class="nav-label">Book Package</span></a>
                </li>
...
<?php /**PATH /home4/avyukhl1/public_html/AHC/resources/views/employee/layouts/app.blade.php ENDPATH**/ ?>