        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="col-lg-7">
                    ...
                    <div class="ibox ">
                        ...
                        <form method="POST" action="<?php echo e(route('hr.update.profile')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Email</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" value="<?php echo e($result->email ?? old('email')); ?>" name="email" class="form-control" diasbled>
...
<div class="hr-line-dashed"></div>
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Address</label>
                                    ...
                                    <div class="col-sm-10">
                                       <?php echo e(Form::text('address', $result->address, ['class'=>'form-control'])); ?>
                                ...
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">City</label>
                                    ...
                                    <div class="col-sm-10">
                                       <?php echo e(Form::text('city', $result->city, ['class'=>'form-control'])); ?>
                                ...
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">State</label>
                                    ...
                                    <div class="col-sm-10">
                                       <?php echo e(Form::text('state_id',$result->state, ['class'=>'form-control'])); ?>
...
<?php echo $__env->make('hr.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/tossamba/public_html/youngman/software/resources/views/hr/updateProfile.blade.php ENDPATH**/ ?>