        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="col-lg-12">
                    ...
                    <div class="ibox ">
                        ...
                        <form method="POST" action="<?php echo e(route('admin.save.test')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group  row">
                                    ...
                                    <label class="col-sm-2 col-form-label">Discription</label>
                                        ...
                                        <div class="col-sm-10">
                                        <textarea name="discription" class="form-control"><?php echo e(old('discription')); ?></textarea>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/seoagencyindia/public_html/healthcare/resources/views/admin/test/add.blade.php ENDPATH**/ ?>