        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="text-muted text-xs block"><?php echo e($result->name); ?> </span>
                        </a>
                    </div>
                ...
                <li <?php if($url=='vendor/dashboard') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('vendor.home')); ?>"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboard</span></a>
                </li>
...
<form id="logout-form" action="<?php echo e(route('vendor.logout')); ?>" method="POST" class="d-none">

        
                                        <?php echo csrf_field(); ?>
                                    </form>
                                    
        <?php echo $__env->make('vendor.layouts.adminError', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /home2/tossamba/public_html/youngman/software/resources/views/vendor/layouts/app.blade.php ENDPATH**/ ?>