            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox ">
                        ...
                        <form method="get" action="<?php echo e(route('call_center.my.booking.mdradone')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                            <div class="row">
                                ...
                                <label class="form-label"></label>
                                    ...
                                    <span style="margin-top: 10px;">
                                            ...
                                            <a href="<?php echo e(route('call_center.my.booking.mdradone')); ?>">
...
<th>Unique Id</th>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($val->username); ?> / <?php echo e($val->booking_for_name); ?>
      ...
      function myBookingViewDetails(id){
          //alert();
                                    ...
                                    $('.callViewModelData').empty();
                                        $.ajax({
                                        type:'POST',
                                        url:"<?php echo e(route('ajaxRequestCallCenter.details.view_call_booking_mdra_done')); ?>",
                                        data:{id:id},   
...
<?php echo $__env->make('call_center.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/avyukhl1/public_html/AHC/resources/views/call_center/booking/mdra_done.blade.php ENDPATH**/ ?>