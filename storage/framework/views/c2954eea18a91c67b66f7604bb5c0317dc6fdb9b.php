                    ...
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
							...
							<?php endif; ?> 
                                        ...
                                        <?php echo Html::decode(link_to_route('admin.delete.employee','<i class="fa fa-trash"></i>',[$val->slug],['class'=>'btn btn-danger','title'=>'Delete','onclick'=>'return deleteConfirm();'])); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/ssashealthcare/public_html/Tos/resources/views/admin/employee/add.blade.php ENDPATH**/ ?>