            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li <?php if($url=='user/dashboard') { ?> class="active" <?php } ?>>
                 ...
                 <li <?php if($url=='user/new-dependent' || $url=='user/dependent-list' || $url=='user/edit-dependent') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('employee.new.dependent')); ?>"><i class="fa fa-dribbble"></i> <span class="nav-label">Dependents</span></a>
                    
                </li>
                 <?php
                        $employeeCompanyData = DB::table('users')->where('id',Auth::user()->company_id)->first();

                ?>
                <?php if(in_array('Corporate Healthcare', explode(',',$employeeCompanyData->products))): ?>
                <li <?php if($url=='user/package-list') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('employee.list.package')); ?>"><i class="fa fa-list-ol"></i> <span class="nav-label">Corporate Healthcare</span></a>
                </li>
                <?php endif; ?>
                 <?php if(in_array('Corporate Vaccination', explode(',',$employeeCompanyData->products))): ?>
                <li <?php if($url=='user/package-list') { ?> class="active" <?php } ?>>
                    <a href="javascript::void();"><i class="fa fa-list-ol"></i> <span class="nav-label">Corporate Vaccination</span></a>
                </li>
                <?php endif; ?>
                 <?php if(in_array('Corporate Wellness', explode(',',$employeeCompanyData->products))): ?>
                <li <?php if($url=='user/package-list') { ?> class="active" <?php } ?>>
                    <a href="javascript::void();"><i class="fa fa-list-ol"></i> <span class="nav-label">Corporate Wellness</span></a>
                </li>
                <?php endif; ?>
                 <?php if(in_array('Image Makeover', explode(',',$employeeCompanyData->products))): ?>
                <li <?php if($url=='user/package-list') { ?> class="active" <?php } ?>>
                    <a href="javascript::void();"><i class="fa fa-list-ol"></i> <span class="nav-label">Image Makeover</span></a>
                </li>
                <?php endif; ?>
                ...
                <!--</li>-->
                <!--<li <?php if($url=='user/feedback-list') { ?> class="active" <?php } ?>>-->
                <!--    <a href="<?php echo e(route('employee.list.feedback')); ?>"><i class="fa fa-users"></i> <span class="nav-label">Feedback Management</span></a>-->
                <!--</li>-->
                ...
                <!--    <a href="<?php echo e(route('employee.faq')); ?>"><i class="fa fa-th-large"></i> <span class="nav-label">FAQ</span></a>-->
                <!--</li>-->
                
                <!--<li <?php if($url=='user/help') { ?> class="active" <?php } ?>>-->
                <!--    <a href="<?php echo e(route('employee.help')); ?>"><i class="fa fa-th-large"></i> <span class="nav-label">Help Center</span></a>-->
                <!--</li>-->
...
<?php else: ?>
<form id="logout-form" action="<?php echo e(route('preuser.logout')); ?>" method="POST" class="d-none">
<?php endif; ?>
...
<div class="modal inmodal" id="myModalViewPackage" tabindex="-1" role="dialog" aria-hidden="true">
                            ...
                            function submitButtion (){
                                ...
                                function checkForm(){
                                    ...
                                    if($('input[type=radio]').is(':checked')) {
                                        if($('input[name=booking_mode]:checked', '#myForm').val() == 'Home Collection'){
                                            ...
                                            if(address_home==null ||address_home == ''){
   ...
   alert('Please select Booking Mode');
                                            $('.button_submit').removeAttr('disabled');
                                            return false;
}
...
$.ajaxSetup({
 ...
 <script>
                                          $('.mydepended_self').change(function(){
                                            //  alert();
                                              ...
                                              if(d_type=='self'){
                                                  ...
                                                  var package_id_select = $('.package_id_select').val();
                                                  $.ajaxSetup({
                                        headers: {
                                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                                        }
                                    ...
                                    $('.dependend_div').empty();
                                        $.ajax({
                                        type:'POST',
                                        url:"<?php echo e(route('ajaxRequest.details.view_all_dependent')); ?>",
                                        data:{id:package_id_select},   
                                        success:function(data){
                                            //alert(data);

                                            $('.dependend_div').empty().append(data);
                                        }
                                        });
...
<?php /**PATH /home2/ssashealthcare/public_html/Software/resources/views/employee/layouts/app.blade.php ENDPATH**/ ?>