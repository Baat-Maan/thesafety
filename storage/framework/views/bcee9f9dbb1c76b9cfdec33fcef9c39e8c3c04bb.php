        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="col-lg-12">
                    ...
                    <div class="ibox ">
                        ...
                        <?php echo e(Form::open(['route'=>['admin.update.test',$result->id],'class'=>'classname','id'=>'myForm','files'=>'true'])); ?>
                        ...
                        <div class="form-group  row">
                                ...
                                <div class="form-group  row">
                                    ...
                                    <label class="col-sm-2 col-form-label">Discription</label>
                                        ...
                                        <div class="col-sm-10">
                                        <textarea name="discription" class="form-control"><?php echo e($result->discription ?? old('discription')); ?></textarea>
                                        
                                        
                                        <span class="" style="color:red"> <?php echo e($errors->first('discription')); ?> <span>
                                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/seoagencyindia/public_html/healthcare/resources/views/admin/test/edit.blade.php ENDPATH**/ ?>