                    ...
                    <div class="ibox ">
                        ...
                        <div class="form-group  row">
                                    ...
                                    <label class="col-sm-2 col-form-label"> Relation</label>
                                        ...
                                        <div class="col-sm-10"><input type="text" value="<?php echo e($result->relation ?? old('relation')); ?>" name="relation" class="form-control">
                                    ...
                                    <label class="col-sm-2 col-form-label"> Contact No</label>
                                        ...
                                        <div class="col-sm-10"><input type="text" value="<?php echo e($result->contact_no ?? old('contact_no')); ?>" name="contact_no" class="form-control">
                                    ...
                                    <label class="col-sm-2 col-form-label"> DOB</label>
                                        ...
                                        <div class="col-sm-3"><input type="date" value="<?php echo e($result->dob ?? old('dob')); ?>" name="dob" class="form-control">
...
<?php echo $__env->make('employee.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/seoagencyindia/public_html/healthcare/resources/views/employee/dependent/edit.blade.php ENDPATH**/ ?>