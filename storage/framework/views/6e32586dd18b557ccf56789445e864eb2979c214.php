            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox ">
                        ...
                        <form method="get" action="<?php echo e(route('admin.my.booking')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                            <div class="row">
      ...
      function myBookingViewDetails(id){
          //alert();
                                    ...
                                    $('.callViewModelData').empty();
                                        $.ajax({
                                        type:'POST',
                                        url:"<?php echo e(route('ajaxRequest.details.view_call_booking_ppd')); ?>",
                                        data:{id:id},   
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/seoagencyindia/public_html/healthcare/resources/views/admin/booking/list.blade.php ENDPATH**/ ?>