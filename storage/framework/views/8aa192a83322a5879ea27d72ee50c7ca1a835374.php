        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="col-lg-12">
                    ...
                    <div class="ibox ">
                        ...
                        <?php echo e(Form::open(['route'=>['admin.update.city',$result->id],'class'=>'classname','id'=>'myForm','files'=>'true'])); ?>
                        ...
                        <div class="form-group  row">
                                    ...
                                    <label class="col-sm-2 col-form-label">State</label>
                                        ...
                                        <div class="col-sm-10"> 
                                            <?php echo e(Form::select('state_id', $states,$result->state_id, ['class'=>'form-control','placeholder'=>'Select State'])); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/seoagencyindia/public_html/healthcare/resources/views/admin/city/edit.blade.php ENDPATH**/ ?>