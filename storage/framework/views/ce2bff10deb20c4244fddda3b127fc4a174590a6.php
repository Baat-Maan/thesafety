    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
               ...
               <!-- <li <?php if($url=='user/daily-status') { ?> class="active" <?php } ?>>
                    <a href="<?php echo e(route('user.new.status')); ?>"><i class="fa-solid fa-user-clock"></i> <span class="nav-label">Daily Status</span></a>
                </li>-->
...
<?php /**PATH /home2/tossamba/public_html/productManagement/software/resources/views/employee/layouts/app.blade.php ENDPATH**/ ?>