        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="col-lg-12">
                    ...
                    <div class="ibox ">
                        ...
                        {{ Form::open(['route'=>['hr.update.event',$result->id],'class'=>'classname','id'=>'myForm','files'=>'true'])}}
                        ...
                        <div class="form-group  row">
                                    ...
                                    <div class="form-group  row">
                                        ...
                                        <div class="col-sm-4"><input type="date" value="{{  $result->from_date ?? old('from_date') }}" name="from_date" class="form-control">
                                        <span class="" style="color:red"> {{ $errors->first('from_date')}} <span></div>
    
    
                                        <label class="col-sm-2 col-form-label">To</label>
    
                                        <div class="col-sm-4"><input type="date" value="{{  $result->from_to ?? old('from_to') }}" name="from_to" class="form-control">
                                    ...
                                    <div class="form-group  row"><label class="col-sm-2 col-form-label">Description</label>
                                        ...
                                        <div class="col-sm-10">
                                        <textarea  name="description" class="form-control">{{ $result->description ?? old('description') }}</textarea>
                                    ...
                                    <div class="form-group  row"><label class="col-sm-2 col-form-label">Address</label>
                                        ...
                                        <div class="col-sm-10">
                                        <textarea  name="address" class="form-control">{{ $result->address ?? old('address') }}</textarea>
